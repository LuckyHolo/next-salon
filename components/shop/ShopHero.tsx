    ...
    <section className="overflow-hidden rounded-3xl bg-white shadow-sm">
      <div className="grid lg:grid-cols-[1.15fr_0.85fr]">
        ...
        <div className="bg-slate-950 px-8 py-10 text-white">
          <p className="text-sm font-medium tracking-[0.3em] text-rose-200 uppercase">
            Visit
          </p>
          <div className="mt-6 space-y-6">
            <div>
              <p className="text-xs text-white/55">Tags</p>
            ...
            <div className="rounded-3xl bg-white/8 p-5">
              <p className="text-sm text-white/70">Review score</p>
